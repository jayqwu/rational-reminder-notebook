...
def main():
    ...
    if args.finance_friday:
        ...
        if latest_title:
            ...
            print("="*70)
            print(f"\nSummarize the discussion from \"{latest_title}\" into an executive summary. DO NOT include content from other episodes. Use an academic, technically precise tone using relevant domain terminology. Group insights under high-level thematic domain headers, using clear paragraph or structured bullet point formatting optimized for readability.")
